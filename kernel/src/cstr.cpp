...
const char* to_hstring(uint64_t value) {
  ...
  for (uint8_t i = 0; i < size; i++) {
    ...
    temp = ((*ptr & 0xF0) >> 4);
    hexTo_StringOutput64[size - (i * 2 + 1)] = temp + (temp > 9 ? 55 : 48);
    temp = ((*ptr & 0x0F));
    hexTo_StringOutput64[size - (i * 2)] = temp + (temp > 9 ? 55 : 48);
  }
...
const char* to_hstring(uint32_t value) {
  ...
  for (uint8_t i = 0; i < size; i++) {
    ptr = ((uint8_t*)valPtr + i);
    temp = ((*ptr & 0xF0) >> 4);
    hexTo_StringOutput32[size - (i * 2 + 1)] = temp + (temp > 9 ? 55 : 48);
    temp = ((*ptr & 0x0F));
    hexTo_StringOutput32[size - (i * 2)] = temp + (temp > 9 ? 55 : 48);
  }
...
const char* to_hstring(uint16_t value) {
  ...
  for (uint8_t i = 0; i < size; i++) {
    ptr = ((uint8_t*)valPtr + i);
    temp = ((*ptr & 0xF0) >> 4);
    hexTo_StringOutput16[size - (i * 2 + 1)] = temp + (temp > 9 ? 55 : 48);
    temp = ((*ptr & 0x0F));
    hexTo_StringOutput16[size - (i * 2)] = temp + (temp > 9 ? 55 : 48);
  }
...
const char* to_hstring(uint8_t value) {
  ...
  for (uint8_t i = 0; i < size; i++) {
    ptr = ((uint8_t*)valPtr + i);
    temp = ((*ptr & 0xF0) >> 4);
    hexTo_StringOutput8[size - (i * 2 + 1)] = temp + (temp > 9 ? 55 : 48);
    temp = ((*ptr & 0x0F));
    hexTo_StringOutput8[size - (i * 2)] =
        temp + (temp > 9 ? 55 : 48);  // 'A' = 55, 'O' = 48
  }
